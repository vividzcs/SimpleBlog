                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_id">
                                @foreach($cates as $d)
                                <option value="{{$d['cate_id']}}"@if($d->cate_id == $field->cate_id) selected @endif>{{str_repeat('&nbsp;&nbsp;&nbsp;',$d['lev']) . $d['cate_name']}}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="{{'/' . $field->art_thumb}}" alt="" id="art_thumb_pre" style="max-width:380px;max-height:100px;">
                        </td>
                    </tr>
                    <tr>
                    <tr>
                        ...
                        <td>
                            <script id="art_content" name="art_content">{!!$field->art_content!!}</script>
                        </td>
                    </tr>
